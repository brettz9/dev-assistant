...
function doSetup()
{
  ...
  browser.contentWindow.wrappedJSObject.toolbarFrame.execFrame.location = "chrome://extensiondev/content/jsenv/blank.html";
  // read startup JS from a file
  try {
    loadFileFromPrefToTextbox("extensions.extensiondev.jsenv.startup", browser.contentWindow.wrappedJSObject.inputFrame.document.getElementById("input"));
  } catch(e) {
...
function save()
{
  var tb = browser.contentWindow.wrappedJSObject.inputFrame.document.getElementById("input");
